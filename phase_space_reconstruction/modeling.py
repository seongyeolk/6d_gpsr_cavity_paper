...
class PhaseSpaceReconstructionModel3D_palxfel_Simulation(torch.nn.Module):
    ...
    def track_and_observe_beam(self, beam, params, ids):
        ...
        lattice_SCM1.elements[ids[1]].K1.data      = params[:,0].unsqueeze(-1)
        lattice_SCM1.elements[ids[0]].K1.data      = params[:,4].unsqueeze(-1)
        ...
        lattice_SCM2.elements[ids[1]].K1.data      = params[:,0].unsqueeze(-1)
        lattice_SCM2.elements[ids[0]].K1.data      = params[:,4].unsqueeze(-1)
