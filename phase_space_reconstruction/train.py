...
from phase_space_reconstruction.modeling import (
    ...
    PhaseSpaceReconstructionModel3D_palxfel_Experiment,
...
def train_3d_scan_palxfel_Experiment(
    train_dset,
    lattice1,
    lattice2,
    p0c,
    ...
    model = PhaseSpaceReconstructionModel3D_palxfel_Experiment(lattice1.copy(), 
                                                     lattice2.copy(), 
                                                     screen1, 
                                                     screen2,
                                                     nn_beam)
