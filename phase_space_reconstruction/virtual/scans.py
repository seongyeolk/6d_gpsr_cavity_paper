...
def run_palxfel_Simulation(beam, 
    ...
    beam : bmadx.Beam
        ground truth beam
    lattice0: bmadx TorchLattice
        diagnostics lattice for SCM_H21
    lattice: bmadx TorchLattice
        diagnostics lattice
    screen: ImageDiagnostic
        diagnostic screen
    RMSBunchLength: RMSBunchLengthMeasurement
    ...
    # =================================================================================
    # SCM 1
    diagnostics_lattice_SCM1.elements[ids[0]].K1.data = params[:,0].unsqueeze(-1)
    diagnostics_lattice_SCM1.elements[ids[1]].K1.data = params[:,4].unsqueeze(-1)
    ...
    # =================================================================================
    # SCM T
    diagnostics_lattice_SCM2.elements[ids[0]].K1.data = params[:,0].unsqueeze(-1)
    diagnostics_lattice_SCM2.elements[ids[1]].K1.data = params[:,4].unsqueeze(-1)
...
def run_palxfel_Experiment(beam, 
                          lattice_SCM1, 
                          lattice_SCM2, 
                          screen1,
                          params,
